...
class WorkspaceMember(Base):
    ...
    role: Mapped[str] = mapped_column(
        Text, CheckConstraint("role IN ('owner', 'editor', 'viewer')"), nullable=False
    )
...
class Paper(Base):
    ...
    __table_args__ = (UniqueConstraint("workspace_id", "file_hash", name="uq_workspace_file_hash"),)
...
class PaperChunk(Base):
    ...
    __table_args__ = (UniqueConstraint("paper_id", "chunk_index", name="uq_paper_chunk_index"),)
...
class Conversation(Base):
    ...
    mode: Mapped[str] = mapped_column(
        Text, CheckConstraint("mode IN ('chat', 'deep_research')"), default="chat"
    )
...
class Message(Base):
    ...
    role: Mapped[str] = mapped_column(
        Text, CheckConstraint("role IN ('user', 'assistant', 'system')"), nullable=False
    )
...
class Citation(Base):
    ...
    chunk_id: Mapped[uuid.UUID | None] = mapped_column(
        ForeignKey("paper_chunks.id", ondelete="SET NULL"), nullable=True
    )
    ...
    verification_status: Mapped[str] = mapped_column(
        Text,
        CheckConstraint("verification_status IN ('verified', 'weak', 'unsupported', 'unverified')"),
        default="unverified",
    )
...
class Job(Base):
    ...
    type: Mapped[str] = mapped_column(
        Text,
        CheckConstraint("type IN ('ingest', 'review', 'deep_research', 'gap_analysis')"),
        nullable=False,
    )
...
class ReviewReport(Base):
    ...
    kind: Mapped[str] = mapped_column(
        Text,
        CheckConstraint("kind IN ('literature_review', 'comparison', 'gap_analysis')"),
        nullable=False,
    )
